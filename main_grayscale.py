...
parser.add_argument('--test_dir', default='./Dataset/ModelA/Grayscale', type=str, help='directory of test dataset')
...
parser.add_argument('--pretrain', default='./ModelA_grayscale/model_50.h5', type=str, help='path of pre-trained model')
...
def train():
    ...
    if args.pretrain:   model = load_model(args.pretrain, compile=False)
        ...
        if args.model == 'DnCNN': model = models_grayscale.DnCNN()
    # compile the model
